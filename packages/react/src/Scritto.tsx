...
const Scritto = ({ value, trend, transition, respectMotionPreference, bounce, hurry, animated = true, ...rest }: Props) => {
  ...
  useLayoutEffect(() => {
    if (ref.current) ref.current.setOptions({ trend, transition, respectMotionPreference, bounce, hurry });
  }, [trend, transition, respectMotionPreference, bounce, hurry]);
