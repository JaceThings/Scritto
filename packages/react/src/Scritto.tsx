...
const Scritto = ({ value, trend, transition, respectMotionPreference, bounce, edgeFade, animated = true, ...rest }: Props) => {
  ...
  useLayoutEffect(() => {
    if (ref.current) ref.current.setOptions({ trend, transition, respectMotionPreference, bounce, edgeFade });
  }, [trend, transition, respectMotionPreference, bounce, edgeFade]);
